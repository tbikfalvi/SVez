...
#ifndef SzolariumAdatH
#define SzolariumAdatH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormSzolariumAdat : public TForm
{
__published:	// IDE-managed Components
   ...
   TLabel *Label169;
   TEdit *EditCsoUzemoraOra;
   TLabel *Label170;
   TEdit *EditCsoUzemoraMax;
   TUpDown *UpDownCsoUzemoraPerc;
   TEdit *EditCsoUzemoraPerc;
   TUpDown *UpDownCsoUzemoraOra;
   TUpDown *UpDownCsoUzemoraMp;
   TLabel *Label171;
   TLabel *Label172;
   TEdit *EditCsoUzemoraMp;
   ...
   void __fastcall CheckBoxInfraClick(TObject *Sender);
   void __fastcall TabControlTablazatChange(TObject *Sender);
   void __fastcall FormShortCut(TWMKey &Msg, bool &Handled);
   void __fastcall BtnResetClick(TObject *Sender);
private:	// User declarations
public:		// User declarations
   void FillControlsWithData( typ_szoliadat stAdat );
   void SaveDataFromControls( typ_szoliadat *stAdat );
   __fastcall TFormSzolariumAdat(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormSzolariumAdat *FormSzolariumAdat;
//---------------------------------------------------------------------------
#endif
