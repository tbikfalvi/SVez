...
//   FormDialogSelectDir->DirectoryListBox->Directory = "Program Files";
   EditDirectory->Text = "C:\\Program Files\\Solarium";
   ...
   try
   {
      ...
      if( RB_Setup->Checked || RB_Update->Checked )
      {
         ...
         else
         {
            ...
            pFiles.push_back( "Szolarium.exe" );
            pFiles.push_back( "Szolarium.eng" );
            pFiles.push_back( "Szolarium.enu" );
            pFiles.push_back( "Szolarium.hun" );
            pFiles.push_back( "Szolarium.srl" );
...
void __fastcall TFormInstallMain::PanelSummaryEnter(TObject *Sender)
{
   try
   {
      ...
      if( RB_Update->Checked )
      {
         ...
         strFile1.sprintf( "%s%s", strPath.c_str(), "Szolarium.exe" );
         strFile2.sprintf( "%s%s", strCurrDir.c_str(), "Szolarium.exe" );
         strTmp.sprintf( "%s -> %s",
